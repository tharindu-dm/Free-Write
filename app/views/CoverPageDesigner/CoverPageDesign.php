            ...
            <div class="product-details">
                ...
                <div class="action-buttons">
                    <?php if ($_SESSION['user_id'] == $design['artist']) : ?>
                        <a href="/Free-Write/public/Designer/edit/<?= $design['covID'] ?>"><button class="edit-button">Edit</button></a>
                    <?php endif; ?>
                    <form action="/Free-Write/public/Designer/delete/<?= $design['covID'] ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this design?');">
