...
<head>
    ...
    <style>
        ...
        input[name="shipping_address"] {
            height: 80px; /* Make shipping address input larger */
            padding-top: 8px;
        }
        ...
        <div class="container">
            <div class="order-details">
                ...
                <div class="shipping-details">
                    ...
                    <input type="text" required name="shipping_address" form="payment-form" placeholder="Shipping Address" maxlength="200">
                    <input type="tel" required name="phone_number" form="payment-form" placeholder="Phone Number" pattern="[0-9+\-\s()]+" title="Enter a valid phone number">
                </div>
            </div>
