...
<body>
  ...
  <main>
    <div class="form-container">
      ...
      <form action="/Free-Write/public/Competition/editCompetition" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <input type="text" maxlength="45" id="title" name="title" placeholder="Enter competition name" value="<?= htmlspecialchars($competitionDetails['title']) ?>" required />
        ...
        <textarea id="rules" name="rules" placeholder="Enter your competition judging criteria" required><?= htmlspecialchars($competitionDetails['rules'] ?? '') ?></textarea>
        ...
        <select id="type" name="type" required>
          ...
          <option value="CoverDesigners" <?= $competitionDetails['type'] === 'CoverDesigners' ? 'selected' : '' ?>>Cover Designers</option>
        </select>

        <label for="category">Category</label>
        <input type="text" id="category" maxlength="45" name="category" placeholder="Enter category" value="<?= htmlspecialchars($competitionDetails['category']) ?>" required />
        <div id="category_error" class="error-message"></div>

        <label for="first_prize">Prize Amount</label>
        <input type="number" id="first_prize" name="first_prize" placeholder="Enter first prize amount" value="<?= htmlspecialchars($competitionDetails['first_prize'] ?? $competitionDetails['prizes']) ?>" required min="0" step="0.01" />
        <div id="first_prize_error" class="error-message"></div>

        <label for="second_prize">Second Prize Amount</label>
        <input type="number" id="second_prize" name="second_prize" placeholder="Enter second prize amount" value="<?= htmlspecialchars($competitionDetails['second_prize'] ?? 0) ?>" required min="0" step="0.01" />
        <div id="second_prize_error" class="error-message"></div>

        <label for="third_prize">Third Prize Amount</label>
        <input type="number" id="third_prize" name="third_prize" placeholder="Enter third prize amount" value="<?= htmlspecialchars($competitionDetails['third_prize'] ?? 0) ?>" required min="0" step="0.01" />
        <div id="third_prize_error" class="error-message"></div>

        <label for="start_date">Start Date</label>
        <input type="date" id="start_date" name="start_date" value="<?= htmlspecialchars($competitionDetails['start_date']) ?>" required />
      ...
      <div class="deleteOverlay-container">
        <div class="deleteOverlay">
          ...
          <form action="/Free-Write/public/Competition/deleteCompetition" method="POST">
            ...
            <input type="text" id="compID-label" disabled value="<?= htmlspecialchars($competitionDetails['competitionID']) ?>">
