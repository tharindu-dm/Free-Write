...
<body>
  ...
  <main>
    <div class="breadcrumb">
      <a href="/Free-Write/public/Competition/Profile/<?= htmlspecialchars($compID ?? '') ?>">Back to competition</a>
            ...
            <div class="winner-card first-place">
                ...
                <div class="winner-details">
                    <?php if (isset($competition['first_place_winner'])): ?>
                        <h3><?php echo htmlspecialchars($competition['first_place_winner_name'] ?? 'Not Announced Yet'); ?></h3>
                        <p class="entry-title"><?php echo htmlspecialchars($competition['first_place_entry_title'] ?? ''); ?></p>
                        <div class="prize-info">
                            <span class="prize-label">Prize:</span>
                            <span class="prize-value">$<?php echo htmlspecialchars($competition['first_prize'] ?? 'N/A'); ?></span>
                        </div>
                    <?php else: ?>
                        <p class="not-announced">Select first winner</p>
                        <input type="hidden" name="winners[first][competition_id]" value="<?php echo htmlspecialchars($competition['competitionID'] ?? ''); ?>">
                            ...
                            <?php if (isset($entryData) && !empty($entryData)): ?>
                                <?php foreach ($entryData as $entry): ?>
                                    <option value="<?php echo htmlspecialchars($entry['entryID']); ?>">
                                        <?php echo htmlspecialchars($entry['bookTitle']); ?> by <?php echo htmlspecialchars($entry['participantName']); ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php else: ?>
            ...
            <div class="winner-card second-place">
                ...
                <div class="winner-details">
                    <?php if (isset($competition['second_place_winner'])): ?>
                        <h3><?php echo htmlspecialchars($competition['second_place_winner_name'] ?? 'Not Announced Yet'); ?></h3>
                        <p class="entry-title"><?php echo htmlspecialchars($competition['second_place_entry_title'] ?? ''); ?></p>
                        <div class="prize-info">
                            <span class="prize-label">Prize:</span>
                            <span class="prize-value">$<?php echo htmlspecialchars($competition['second_prize'] ?? 'N/A'); ?></span>
                        </div>
                    <?php else: ?>
                        <p class="not-announced">Select second winner</p>
                        <input type="hidden" name="winners[second][competition_id]" value="<?php echo htmlspecialchars($competition['competitionID'] ?? ''); ?>">
            ...
            <div class="winner-card third-place">
                ...
                <div class="winner-details">
                    <?php if (isset($competition['third_place_winner'])): ?>
                        <h3><?php echo htmlspecialchars($competition['third_place_winner_name'] ?? 'Not Announced Yet'); ?></h3>
                        <p class="entry-title"><?php echo htmlspecialchars($competition['third_place_entry_title'] ?? ''); ?></p>
                        <div class="prize-info">
                            <span class="prize-label">Prize:</span>
                            <span class="prize-value">$<?php echo htmlspecialchars($competition['third_prize'] ?? 'N/A'); ?></span>
                        </div>
                    <?php else: ?>
                        <p class="not-announced">Select third winner</p>
                        <input type="hidden" name="winners[third][competition_id]" value="<?php echo htmlspecialchars($competition['competitionID'] ?? ''); ?>">
          ...
          <tbody>
            <?php if (isset($entryData['participantID'])): ?>
              ...
              <tr>
                ...
                <td>
                  <a href="/Free-Write/public/Book/Overview/<?= htmlspecialchars($entryData['bookID'] ?? '') ?>" class="view-btn">View Book</a>
                </td>
              </tr>
            <?php else: ?>
              ...
              <?php foreach ($entryData as $entry): ?>
                <tr>
                  ...
                  <td>
                    <a href="/Free-Write/public/Book/Overview/<?= htmlspecialchars($entry['bookID'] ?? '') ?>" class="view-btn">View Book</a>
                  </td>
                </tr>
              <?php endforeach; ?>
            <?php endif; ?>
