...
<body>
    ...
    <div class="header">
        ...
        <a href="/Free-Write/public/Competition/ViewStats/<?= htmlspecialchars($competitionDetails['competitionID']) ?>" class="enter-btn"><button>View Stats</button></a>
    ...
    <div class="container">
        <?php if (!empty($competitionDetails['compImage'])): ?>
            <div class="competition-image-container">
                <img src="/Free-Write/app/images/competition/<?= htmlspecialchars($competitionDetails['compImage']) ?>" alt="Competition Image" class="competition-image">
            </div>
        <?php endif; ?>
        ...
        <div class="card">
            ...
            <p><strong>Submission Deadline:</strong> <?= date('F j, Y', strtotime($competitionDetails['end_date'] ?? 'now')) ?></p>
            <p><strong>Start Date:</strong> <?= date('F j, Y', strtotime($competitionDetails['start_date'] ?? 'now')) ?></p>
