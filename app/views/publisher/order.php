...
<head>
  ...
  <style>
    ...
    .order-table td {
      ...
      min-width: 100px; /* Added to prevent content wrapping */
    }
...
<body>
  ...
  <div class="stats-header">
    ...
    <a href="/Free-Write/public/Order/viewStats" class="view-stats-button" aria-label="View detailed statistics">View Statistics</a>
  </div>
  ...
  <main class="main-content">
    ...
    <div id="all-orders" class="order-view active">
      ...
      <div class="order-search-container">
        <div class="order-search-bar">
          <input type="text" placeholder="Search by book title or customer name" aria-label="Search orders by book title or customer name">
        </div>
        ...
        <tbody>
          <?php if (isset($data['orders']) && !empty($data['orders'])): ?>
            <?php foreach ($data['orders'] as $order): ?>
              ...
              ?>
              <tr>
                <td><a href="/Free-Write/public/Order/orderDetail/<?= htmlspecialchars($order['orderID']) ?>"><?= htmlspecialchars($order['bookTitle'] ?? ''); ?></a></td>
    ...
    <div id="new-orders" class="order-view">
      ...
      <div class="order-search-container">
        <div class="order-search-bar">
          <input type="text" placeholder="Search by book title or customer name" aria-label="Search new orders by book title or customer name">
        </div>
        ...
        <tbody>
          <?php if (isset($data['orders']) && !empty($data['orders'])): ?>
            ...
            <?php if (!$newOrdersFound): ?>
              <tr>
                <td colspan="6" class="empty-state">No new orders found. <a href="/Free-Write/public/Order/create">Create a new order</a>.</td>
              </tr>
            <?php endif; ?>
          <?php else: ?>
            <tr>
    ...
    <div id="processing-orders" class="order-view">
      ...
      <div class="order-search-container">
        <div class="order-search-bar">
          <input type="text" placeholder="Search by book title or customer name" aria-label="Search in preparation orders by book title or customer name">
        </div>
    ...
    <div id="shipped-orders" class="order-view">
      ...
      <div class="order-search-container">
        <div class="order-search-bar">
          <input type="text" placeholder="Search by book title or customer name" aria-label="Search out for delivery orders by book title or customer name">
        </div>
    ...
    <div id="completed-orders" class="order-view">
      ...
      <div class="order-search-container">
        <div class="order-search-bar">
          <input type="text" placeholder="Search by book title or customer name" aria-label="Search completed orders by book title or customer name">
        </div>
