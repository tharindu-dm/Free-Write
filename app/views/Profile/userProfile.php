    ...
    <main>
                                    ...
                                    <?php foreach ($data['advertisements'] as $ad): ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/Free-Write/public/Publisher/applyingAdvertisement/<?= htmlspecialchars($ad['adID']) ?>"><button class="edit-btn">
                                ...
                                <?php foreach ($orders as $order): ?>
                                    <tr class="order-row">
                                        ...
                                        <td class="order-actions">
                                            <a href="cancel-order.php?id=<?= htmlspecialchars($order['orderID']); ?>" class="btn btn-cancel">Cancel</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                                    ...
                                    <tr class="cart-row">
                                        ...
                                        <td>
                                            <div class="quantity-control">
                                                <button class="quantity-btn minus" data-cart-id="<?= htmlspecialchars($item['cartID']) ?>">-</button>
                                                <span class="quantity"><?= htmlspecialchars($item['quantity']) ?></span>
                                                <button class="quantity-btn plus" data-cart-id="<?= htmlspecialchars($item['cartID']) ?>">+</button>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a href="/Free-Write/public/Publisher/paymentPage/<?= htmlspecialchars($item['bookID']) ?>/<?= htmlspecialchars($item['quantity']) ?>" class="checkout-btn-small">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        ...
        <?php else: ?>
            <div class="empty-cart">
                <div class="empty-state">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="empty-cart-icon">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                    </svg>
