            ...
            <div class="product-layout">
                ...
                <div class="product-info">
                    ...
                    <div class="space_between">
                        <div>
                            <div class="rating">
                                <?= $book[0]['viewCount'] > 0 ? 'Views: ' . htmlspecialchars($book[0]['viewCount']) : 'No Views'; ?>
                            </div>
                    ...
                    <div class="table-of-contents">
                        ...
                        <button class="book-btn"
                            onclick="window.location.href='/Free-Write/public/Writer/writeChapter/<?= htmlspecialchars($book[0]['bookID']); ?>'">Add
                            New Chapter</button>
                    </div>
