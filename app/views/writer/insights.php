            ...
            <div class="featured-section">
                <?php if (!empty($MostViewed) && is_array($MostViewed)): ?>
                    ...
                    <div class="featured-book-card">
                        ...
                        <div>
                            <h3><?= htmlspecialchars($MostViewed[0]['title']) ?></h3><br>
                            <p><?= htmlspecialchars($MostViewed[0]['synopsis']) ?></p>
                            <span><strong><?= htmlspecialchars($MostViewed[0]['views'] ?? 'No') ?> views</strong></span>
                        </div>
                    </div>
                    <br>
                    <label class="most_viewed">Most Viewed Book</label>
                    </a>
                    ...
                    <div class="chart-container">
                        ...
                        foreach ($MostViewed as $book):
                            ...
                            $views = $book['views'];
                            $widthPercent = ($views / $maxViews) * 100;
                        ?>
                        <div class="bar">
