                ...
                <?php else: ?>
                    ...
                    <ul class="quote-item">
                        <?php foreach ($quotas as $quota): ?>
                            <li>
                                <a href="/Free-Write/public/Writer/ViewQuota/<?php echo htmlspecialchars($quota['quotaID']); ?>"
                                    class="quote-link">
                                    <p>
                                        <?php echo htmlspecialchars($quota['publisher']); ?>
                                        <br>
                                        <small>Last Edited: <strong><?php echo htmlspecialchars($quota['lastEditedDate']); ?>
                                            </strong></small>
                                    </p>
                                </a>
