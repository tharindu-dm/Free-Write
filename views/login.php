            ...
            <div>
                ...
                <div id="register-form-div">
                    <form id="register-form" action="/Free-Write/public/Login/register" method="POST">
                        ...
                        <input type="email" name="signup-email" id="emailReg" placeholder=" Enter your email" required>

                        <input type="password" id="passwordReg" name="pw" placeholder="Password" required>

                        <input type="password" id="confpass" name="confpw" placeholder="Confirm Password" required>
